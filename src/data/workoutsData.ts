...
export const WORKOUT_CATEGORIES_INFO = [
  ...
  },
  {
    ...
    img: getExerciseGifUrl("Barbell Bench Press", "Gym Workouts"),
    isProgram: true,
...
export const WORKOUTS_DATABASE: Workout[] = [
  // ================= CATEGORY 1 =================
  {
    ...
    imageUrl: getExerciseGifUrl("Barbell Squat", "Gym Workouts"),
    ...
    exercises: [
      ...
      { name: "Step Ups with Knee Drive", sets: "3", reps: "12 each side", rest: "30 seconds" }
    ]
  },
  {
    ...
    imageUrl: getExerciseGifUrl("Plank", "Home Workouts"),
  ...
  },
  {
    ...
    caloriesBurned: 220,
    equipmentNeeded: "No Equipment",
    imageUrl: getExerciseGifUrl("World's Greatest Stretch Complex", "Home Workouts"),
  ...
  },
  {
    ...
    imageUrl: getExerciseGifUrl("Standing Dumbbell Overhead Shoulder Press", "Gym Workouts"),
  ...
  },
  {
    ...
    exercises: [
      { name: "Crunches", sets: "4", reps: "20", rest: "30 seconds" },
      { name: "Plank", sets: "3", reps: "45 seconds", rest: "30 seconds" },
      { name: "Russian Twist", sets: "3", reps: "24 twists", rest: "30 seconds" },
      { name: "Leg Raises", sets: "3", reps: "15", rest: "45 seconds" },
      { name: "Mountain Climbers", sets: "3", reps: "30 seconds", rest: "30 seconds" },
      { name: "Bicycle Crunch", sets: "3", reps: "20", rest: "30 seconds" }
    ]
  },
  ...
  },
  {
    ...
    imageUrl: getExerciseGifUrl("Barbell Bench Press", "Gym Workouts"),
  ...
  },
  {
    ...
    imageUrl: getExerciseGifUrl("Barbell Row", "Gym Workouts"),
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Mountain Climbers", sets: "3", reps: "40 seconds", rest: "30 seconds" }
    ]
  },
  {
    ...
    caloriesBurned: 180,
    equipmentNeeded: "Light Dumbbells",
    imageUrl: getExerciseGifUrl("Barbell Curl", "Gym Workouts"),
  ...
  },
  {
    ...
    exercises: [
      { name: "Diamond Push Ups", sets: "3", reps: "12", rest: "45 seconds" },
  ...
  },
  {
    ...
    exercises: [
      { name: "Crunches", sets: "1", reps: "60 seconds", rest: "0 seconds" },
      ...
      { name: "Mountain Climbers", sets: "1", reps: "60 seconds", rest: "0 seconds" }
    ]
  },
  {
  ...
  },
  {
    ...
    exercises: [
      { name: "Mountain Climbers", sets: "1", reps: "5 minute warm-up", rest: "0 seconds" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Glute Bridges", sets: "3", reps: "20", rest: "30 seconds" },
      { name: "Crunches", sets: "3", reps: "20", rest: "30 seconds" },
      { name: "Plank", sets: "3", reps: "45 seconds", rest: "30 seconds" },
      { name: "Bicycle Crunch", sets: "3", reps: "20", rest: "30 seconds" }
    ]
  },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Mountain Climbers", sets: "4", reps: "45 seconds", rest: "15 seconds" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Leg Curl", sets: "3", reps: "15", rest: "45 seconds" },
