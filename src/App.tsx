...
import { PATH_TO_VIEW_MAP, VIEW_TO_PATH_MAP, resolveViewFromPath } from "./constants/routes";
...
function FitnessAppContent() {
  ...
  React.useEffect(() => {
    const handlePopState = (event: PopStateEvent) => {
      ...
      // 2. Second priority: match current pathname using canonical resolver
      const targetView = resolveViewFromPath(window.location.pathname);
