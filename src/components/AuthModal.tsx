            ...
            {!isForgot && (
              <div className="space-y-3">
                ...
                <button
                  ...
                  type="button"
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-900 bg-black hover:bg-slate-900 rounded-lg text-xs font-semibold text-white transition cursor-pointer shadow-sm"
                >
