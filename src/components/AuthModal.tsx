            ...
            {!isForgot && (
              <div className="space-y-3">
                ...
                <button
                  ...
                  type="button"
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-slate-200 hover:bg-slate-50:bg-slate-900 rounded-lg text-xs font-semibold text-slate-700 transition cursor-pointer bg-white"
                >
