    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* LEFT: Dynamic Product Images (Up to 7 slots & touch swipe) */}
          <div className="w-full md:w-1/2 bg-slate-100 p-4 sm:p-6 flex flex-col justify-start relative select-none">
            <ProductImageGallery 
              product={product} 
